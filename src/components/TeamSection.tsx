  ...
  return (
    <section className="relative">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative md:absolute md:bottom-12 md:right-12 bg-card/95 backdrop-blur-sm border border-border p-8 md:p-10 max-w-md mx-6 md:mx-0 -mt-24 md:mt-0 z-10"
      >
